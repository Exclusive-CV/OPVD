# -*- coding: utf-8 -*-
"""
Created on Mon Jun 12 19:55:36 2023
...
train_data.to_json('/root/CodeXGLUE/data/codexglue_train_raw.json', force_ascii=False)
valid_data.to_json('/root/CodeXGLUE/data/codexglue_valid_raw.json', force_ascii=False)
test_data.to_json('/root/CodeXGLUE/data/codexglue_test_raw.json', force_ascii=False)
